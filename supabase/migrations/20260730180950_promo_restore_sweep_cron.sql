...
--
-- PRE-REQUISITO OPERACIONAL (uma vez, fora do git):
--   select vault.create_secret('<service_role_key>', 'service_role_key');
-- Sem esse segredo o tick nao tem como se autenticar na edge function. Ele
-- detecta a ausencia e sai com um warning, em vez de disparar um 401 por hora.
